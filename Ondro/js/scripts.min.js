...
$(function(){$("#my-menu").mmenu({extensions:["widescreen","theme-white","effect-menu-slider","pagedim-black","position-left"],navbar:{title:'<img src="img/bihlogodark.png" class="logo">'}});var e=$("#my-menu").data("mmenu"),o=$(".hamburger");e.bind("open:finish",function(){setTimeout(function(){o.addClass("is-active")},10)}),e.bind("close:finish",function(){setTimeout(function(){o.removeClass("is-active")},10)}),$(".carousel-content").owlCarousel({loop:!0,nav:!0,smartSpeed:700,responsiveClass:!0,dots:!0,navText:['<i class="fas fa-angle-double-left"></i>','<i class="fas fa-angle-double-right"></i>'],autoplay:!0,autoplayTimeout:5e3,autoplayHoverPause:!0,responsive:{0:{items:1}}}),$(".carousel-project1-first, .carousel-project1-second, .carousel-project3, .carousel-project4, .carousel-project5-first, .carousel-project5-second, .carousel-project7, .carousel-project8").owlCarousel({loop:!0,nav:!0,smartSpeed:700,responsiveClass:!0,dots:!0,navText:['<i class="fas fa-angle-double-left "></i>','<i class="fas fa-angle-double-right"></i>'],autoplay:!0,autoplayTimeout:5e3,autoplayHoverPause:!0,responsive:{0:{items:1}}}),$('a[data-target^="anchor"]').bind("click.smoothscroll",function(){var e=$(this).attr("href"),o=$(e).offset().top;return $("body, html").animate({scrollTop:o},1500),!1}),$("body").append('<button class="btn_up" />'),$(".btn_up").click(function(){$("body").animate({scrollTop:0},1e3),$("html").animate({scrollTop:0},1e3)}),$(window).scroll(function(){200<$(window).scrollTop()?$(".btn_up").addClass("active"):$(".btn_up").removeClass("active")})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});